    ...
    <div class="col-sm-12">
        <div class="py-5 section">
            ...
            <div class="mt-3 text-center">
                @if($traderview->is_commisioner_approval == 0)   <button class="btn btn-warning" type="button" onclick="helpModal('#comply-pop')"><i class="priya-mail-reply"></i> Comply</button>
