     ...
     <div class="col-sm-9">
        <div class="py-5 section">
            <card class="card">
                ...
                <div class="card-body">
					<form id="mandalfrm" name="mandalfrm" enctype="multipart/form-data" action="{{url('/')}}/admin/usertype" method="post" onsubmit="return rythuBazaarValidateFunc();">
                     	@csrf
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label>Role Type <span class="text-danger">*</span></label>
									<input type="number" name="type"  class="form-control pri-form" required="" autocomplete="off"/>
                                </div>
                            </div> 
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label>Role Type Name<span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control pri-form" required="" autocomplete="off"/>
                                </div>
                            </div> 
