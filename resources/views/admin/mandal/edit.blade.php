...
<div class="container-fluid bdy">
    ...
    <div class="col-sm-9">
        <div class="py-5 section">
            <card class="card">
                <h5 class="card-header">Edit Mandal
                ...
                <div class="card-body">
                    <form id="mandalfrm" name="mandalfrm" enctype="multipart/form-data" action="{{url('/')}}/admin/mandal/{{$mandal->id}}" method="post" >
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control pri-form" autocomplete="off" required value="{{$mandal->name}}" />
                                </div>
                            </div>                  
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control pri-form" name="district_id" required>
                                        ...
                                        @foreach($district as $s)
                                            <option value="{{$s->id}}" @if($s->id == $mandal->district_id) selected @endif>{{$s->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>                  
