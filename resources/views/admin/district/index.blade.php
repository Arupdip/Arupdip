...
<div class="container-fluid bdy">
    ...
    <div class="col-sm-9">
        <div class="py-5 section">
            <card class="card">
                <h5 class="card-header">Manage District
                        ...
                        <table class="table table-stripped table-bordered theme-tbl datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{$d->name}}</td>
                                  <td>{{$d->code}}</td>
                                  <td>{{$d->state->state_title}}</td>
                                  <td align="center">
                                      <a href="{{url('/')}}/admin/district/{{$d->id}}/edit" class="btn btn-icon btn-info" title="Edit"><i class="priya-edit"></i></a> 
