    ...
    <div class="col-sm-9">
        <div class="py-5 section">
            <card class="card">
                ...
                <div class="card-body">
                    <form id="mandalfrm" name="mandalfrm" enctype="multipart/form-data" action="{{url('/')}}/admin/amc/{{$amc->id}}" method="post" >
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control pri-form" autocomplete="off" required value="{{$amc->name}}" />
                                </div>
                            </div>                  
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control pri-form" name="district_id" required>
                                        ...
                                        @foreach($district as $s)
                                            <option value="{{$s->id}}" @if($s->id == $amc->district_id) selected @endif>{{$s->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>    
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" required class="form-control pri-form">{{$amc->address}}</textarea>
                                </div>
                            </div> 
