...
<div class="container-fluid bdy">
    ...
    <div class="col-sm-12">
        <div class="py-5 section">
            ...
            <div class="mt-3 text-center">
                @if($cadata->is_amc_approval == 0)   <button class="btn btn-warning" type="button" onclick="helpModal('#comply-pop')"><i class="priya-mail-reply"></i> Comply</button>
 ...
 <div id="approve-pop" class="help-modal" style="display: none;">
    <div class="help-modal-content no-gap">
        ...
        <section>
            <form name="approvesubmitform" id="approvesubmitform" method="POST" action="{{url('amc/caapprovesubmit')}}">
                @csrf
