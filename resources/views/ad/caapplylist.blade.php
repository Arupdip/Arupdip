                            ...
                            <tbody>
                              ...
                              <?php $i++;?>
                                <tr>
                                  ...
                                  @endif
                                  <td align="center">
                                    <a href="{{url('/')}}/ad/caviewdetails/{{$row->application_id}}" class="btn btn-icon btn-info" title="View Details"><i class="priya-eye"></i></a> 
                                    <a href="{{url('/')}}/ad/caviewdetails/{{$row->application_id}}" class="btn btn-icon btn-info" title="View Details"><i class="priya-edit"></i></a> 
