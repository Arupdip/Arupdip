            ...
            <div class="sub-menu" id="menu-slide">
                <div class="row">
                    <div class="col-md-3">
                        <ul class="ico-menu">
                            <li>
                                <label><i class="priya-dashboard"></i> <a href="{{url('/')}}/trader">Dashboard</a><input type="checkbox" /></label>
                            </li>
                            <li>
                                <label><i class="priya-dashboard"></i> <a href="{{url('/')}}/trader/my-application-list">Application List</a><input type="checkbox" /></label>
                            </li>
                        </ul>
                    </div>
