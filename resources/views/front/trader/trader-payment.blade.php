                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                         ...
                         <div class="payment-options collapse">
                            <a href="{{url("/")}}/trader-regpay-success/{{$id}}" class="payment-option" ><img src="../images/sbi-logo.png" alt=""></a>
                            <a href="{{url("/")}}/trader-regpay-success/{{$id}}" class="payment-option" ><img src="../images/PayU.jpg" alt=""></a>
                        </div> 
