...
<div class="container-fluid bdy">
    <div class="card my-5">
        <div class="card-head">
            <h4 class="m-0 px-4 pt-3">Final Payment
                <div class="btn-grp">
                ...
                <form name="" class=" clearfix" action="" novalidate="novalidate">
                    <div class="form-section">
                        ...
                        <div class="payment-options collapse"> 
                            <a href="{{url('/')}}/ca/final-payment-success/{{$id}}" class="payment-option"><img
                                    src="{{asset('images/sbi-logo.png')}}" alt=""></a>
                            <a href="{{url('/')}}/ca/final-payment-success/{{$id}}" class="payment-option"><img
                                    src="{{asset('images/PayU.jpg')}}" alt=""></a>
                        </div>
