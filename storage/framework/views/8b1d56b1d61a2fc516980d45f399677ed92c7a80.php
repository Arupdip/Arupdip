            ...
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <div class="login-box">
                        ...
                        <form id="loginfrm" name="loginfrm" action="<?php echo e(url('admin/post-login')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH G:\PleskVhosts\ramidinfosolution.com\OLMS1.ramidinfosolution.com\resources\views/admin/login.blade.php ENDPATH**/ ?>