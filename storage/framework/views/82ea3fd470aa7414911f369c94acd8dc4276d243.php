                ...
                <div class="sub-menu" id="menu-slide">
                    <div class="row">
                        <div class="col-md-3">
                            <ul class="ico-menu">
                                <li>
                                    <label><i class="priya-dashboard"></i> <a href="./dashboard">Dashboard</a><input type="checkbox" /></label>
                                </li>
                                <li>
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li><a href="traders-list.html">Pending Registrations</a></li>
                                    </ul>
                                </li>
                                <li>
                        ...
                        <div class="col-md-3">
                            <ul class="ico-menu">
                            <li>
                                    <label><i class="priya-flag-checkered"></i>Allotments<input type="checkbox" /> <i class="priya-caret-down float-right mt-1"></i></label>
                                    <ul class="collapse">
                                        <li><a href="#">Free Allotment</a></li>
                                        <li><a href="#">Fixed Allotment</a></li>
                                        <li><a href="#">Rotational Allotment</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <label><i class="priya-cubes"></i>Stockout<input type="checkbox" /> <i class="priya-caret-down float-right mt-1"></i></label>
                                    <ul class="collapse">
                                        <li><a href="#">Inventory List</a></li>
                                        <!-- <li><a href="./dashboard/inventory-lists/add">Add Inventory</a></li> -->
                        ...
                        <div class="col-md-3">
                            <ul class="ico-menu">
                                ...
                                <li>
                                    <label><i class="priya-gears"></i> <a href="../master.html">Setting</a><input type="checkbox" /></label>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<footer class="main-footer text-center py-3">&copy; <script>document.write(new Date().getFullYear())</script>  Department</footer>
 </div>

</body>
</html><?php /**PATH D:\xampp\htdocs\olms\resources\views/layouts/adminlayout.blade.php ENDPATH**/ ?>