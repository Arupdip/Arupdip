...
<div class="container-fluid bdy">
    ...
    <div class="col-sm-9">
        <div class="py-5 section">
            <card class="card">
                <h5 class="card-header">Manage License Type
                    ...
                    <div class="table-responsive">
                        <table class="table table-stripped table-bordered theme-tbl datatable">
                            ...
                            <tbody>
                                <?php
                                $i=0; ?>
                                <?php $__currentLoopData = $licensetype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                $i++; ?>
                                <tr>
                                  <td><?php echo e($i); ?></td>
                                  ...
                                  <td align="center">
                                      <a href="<?php echo e(url('/')); ?>/admin/licensetype/<?php echo e($d->id); ?>/edit" class="btn btn-icon btn-info" title="Edit"><i class="priya-edit"></i></a> 
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "DELETE",
        url: "<?php echo e(url('/')); ?>/admin/licensetype/"+id,
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\olms\resources\views/admin/licensetype/index.blade.php ENDPATH**/ ?>