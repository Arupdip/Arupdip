...
<div class="container-fluid bdy">
    ...
    <div class="col-sm-9">
        <div class="py-5 section">
            <card class="card">
                <h5 class="card-header">Add Designation
                ...
                <div class="card-body">
                    <form id="mandalfrm" name="mandalfrm" enctype="multipart/form-data" action="<?php echo e(url('/')); ?>/admin/designation" method="post" >
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\olms\resources\views/admin/designation/create.blade.php ENDPATH**/ ?>